        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-4 px-8 rounded-1g font-semibold text-lg hover:bg-blue-700 transform hover:scale-[1.02] transition-all duration-200 shadow-5g hover:shadow-xl flex items-center justify-center gap-2"
              >
