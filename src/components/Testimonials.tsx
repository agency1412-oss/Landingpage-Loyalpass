              ...
              >
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    {testimonial.project && <p className="text-gray-500 text-xs mb-1"><span className="font-semibold">project:</span> {testimonial.project}</p>}
                    {testimonial.year && <p className="text-gray-500 text-xs mb-2"><span className="font-semibold">year:</span> {testimonial.year}</p>}
